...
<<<<<<< HEAD
  name = "project207-sec-gr-comp-wolf"
  tags = {
    Name = "project207-sec-gr-comp-wolf"
=======
  name = var.mysecgr
...
resource "null_resource" "config" {
  ...
  connection {
    ...
    user = "ec2-user"
<<<<<<< HEAD
    private_key = file("~/.ssh/comp-wolf.pem")
=======
...
>>>>>>> 8eb9fe008189ea95f3340e1f39a75f59a212de6e
  ...
  provisioner "file" {
<<<<<<< HEAD
    source = "~/.ssh/comp-wolf.pem"
    destination = "/home/ec2-user/comp-wolf.pem"
=======
    # Do not forget to define your key file path correctly!
