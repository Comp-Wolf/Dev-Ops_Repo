...
- Codes written by clww developers should be pulled from clww Repo into the Jenkins server and sent them to the EC2's from here with Ansible.
...
```bash
208:clww_jenkins_project (folder)
|
